...
const Article = ({ id, image, title, category, author, deleteArticle, open }) => {
  ...
  return (
    <div
      key={id}
      className={`grid grid-cols-1 grid-rows-[10rem,1fr] relative flex-col items-center w-[30rem] h-[40rem] bg-black shadow-md shadow-red-500 my-10 p-20 hover:translate-x-2 hover:translate-y-[-0.5rem] hover:cursor-pointer hover:shadow-xl hover:shadow-red-500`}>
